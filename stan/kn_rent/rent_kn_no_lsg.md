...
![](rent_kn_no_lsg_files/figure-gfm/no_pooling-1.png)<!-- -->
...
![](rent_kn_no_lsg_files/figure-gfm/complete_pooling-1.png)<!-- --> For
the individual cities there is less spread. But some of them only have
one data point, therefore full pooling does not work and hierarchical
models come to shine.
...
![](rent_kn_no_lsg_files/figure-gfm/joy_intercept-1.png)<!-- -->
...
![](rent_kn_no_lsg_files/figure-gfm/joy_slope-1.png)<!-- -->
