...
teams <- c("Germany", "France", "Spain", "Netherlands", "Italy", "Croatia", 
                   "Belgium", "Portugal", "Switzerland", "Poland", "Denmark", 
                   "Austria", "Turkey", "Czechia", "Hungary", "England", "Scotland", 
                   "Serbia", "Romania", "Albania", "Slovenia", "Slovakia", "Finland", "Georgia")

# Create a lookup table with all country names and their corresponding codes (if needed)
lookup <- data.frame(
 Code = c("de", "fr", "es", "nl", "it", "hr", "be", "pt", "ch", "pl", "dk", "at", "tr", "cz", "hu", "gb", "gb", "rs", "ro", "al", "si", "sk", "fi", "ge"),
  Name = teams
)
...
Total number of games between teams taking part in the Euro 2024: 115
...
|     Finland | 2         |         0 | Slovenia    | 2023-06-16 | UEFA European Football Championship Qualifying |        https://fbref.com/en/matches/ef7c7eb9/Finland-Slovenia-June-16-2023-UEFA-Euro-Qualifying |
...
|    Slovenia | 3         |         0 | Finland     | 2023-10-14 | UEFA European Football Championship Qualifying |     https://fbref.com/en/matches/cb94b705/Slovenia-Finland-October-14-2023-UEFA-Euro-Qualifying |
...
|      Turkey | 2         |         1 | Czechia     | 2022-11-19 |                   International Friendlies (M) |             https://fbref.com/en/matches/1c4fed81/Turkiye-Czechia-November-19-2022-Friendlies-M |
