...
```{stan output.var="model_1", eval=FALSE}
data {
  int<lower=0> K;
  vector[K] sigma;
  matrix[K,K] rho;
...
-   `L_u=L'` the Cholesky Decomposition of the correlation matrix (unit diagonal) which stores the attack and defense correlation. For the two dimensional case in football this is one variable.
