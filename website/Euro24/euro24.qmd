...
```{r, echo=TRUE, collapse=FALSE, warning=FALSE, fig.width=4, fig.height=3}
library(tidyverse)
library(ggplot2)
...
11, 18.06, Türkiye, Georgia, 18:00
...
23, 21.06, Türkiye, Portugal, 18:00
...
36, 25.06, Czechia, Türkiye, 21:00"
...
```{r individual_plots, echo=FALSE, results='asis', fig.width=4, fig.height=3}
