...
b)  The code for the Metropolis-Hastings algorithm can be found at https://github.com/oduerr/da/blob/master/code/MCMC_MH.R you can use via
...
c) Formulate the same problem in Stan, have a lock at the code to come up with the complete code including the priors.
Sample one chain from the posterior.
...
Compare the trace plots of the slope from the Metropolis-Hastings algorithm and Stan. Also compare the posterior plots. Which of the two algorithms has a larger $n_eff$? 
