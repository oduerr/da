...
a) Change the following "Metropolis King of the Archipelago" algorithm (code from https://oduerr.github.io/anim/mcmc_mh.html) so that the size of the island $i$ is proportional to $i^2$. Visualize the resulting chain (first 200 steps) and the distribution. 
