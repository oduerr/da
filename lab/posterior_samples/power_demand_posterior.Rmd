...
Suppose you manage a company with has a high electric energy consumption for production. You also have you own inhouse energy resources (e.g. solar power). Such energy sources usually have high fluctuations in the energy production. You can also buy energy at the market a day ahead (at 300 Euro / megawatt hour). If you use more power than you ordered, you have to pay 1000 Euro / MWh as a fine. If you use less you have to pay the the amount you ordered, but no extra cost apply.
...
samples = read.table('http://www-home.htwg-konstanz.de/~oduerr/data/power_post.csv')
