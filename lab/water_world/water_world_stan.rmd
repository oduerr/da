...
```{r, echo=lsg, eval=FALSE, code=readLines("~/Documents/GitHub/da/lab/water_world/world.stan"), collapse=TRUE, echo=TRUE}
#Stan Code
```
...
W = 6
N = 9
samples_cmd = model$sample(data = list(N=N, W=W), seed=123, show_messages = FALSE)
